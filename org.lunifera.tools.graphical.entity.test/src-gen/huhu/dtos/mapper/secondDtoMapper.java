...
public class secondDtoMapper implements IMapper<secondDto, second> {
   ...
   * 
   */
  public void mapToDTO(final secondDto dto, final second entity) {
   ...
   * 
   */
  public void mapToEntity(final secondDto dto, final second entity) {
   ...
   * 
   */
  protected Long toDto_pid(final second in) {
    return in.getPid();
  }
   ...
   * 
   */
  protected sdfsdfDto toDto_myreference(final second in) {
   ...
   * 
   */
  protected sdfsdf toEntity_myreference(final secondDto in) {
    org.lunifera.dsl.dto.lib.IMapper<sdfsdfDto, sdfsdf> mapper = getMapper(sdfsdfDto.class, sdfsdf.class);
    if(mapper != null) {
    	throw new IllegalStateException("Mapper must not be null!");
    }

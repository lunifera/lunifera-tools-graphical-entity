...
public class Bean1DtoMapper implements IMapper<Bean1Dto, Bean1> {
   ...
   * 
   */
  public void mapToDTO(final Bean1Dto dto, final Bean1 entity) {
   ...
   * 
   */
  public void mapToEntity(final Bean1Dto dto, final Bean1 entity) {
   ...
   * 
   */
  protected String toDto_pid(final Bean1 in) {
    return in.getPid();
  }
   ...
   * 
   */
  protected Date toDto_pdate(final Bean1 in) {
    return in.getPdate();
  }

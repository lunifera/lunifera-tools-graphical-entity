...
import huhu.Bean2Dto;
import huhu.mapper.Bean1DtoMapper;
...
public class Bean2DtoMapper extends Bean1DtoMapper {
   ...
   * 
   */
  public void mapToDTO(final Bean2Dto dto, final huhu.Bean2 entity) {
   ...
   * 
   */
  public void mapToEntity(final Bean2Dto dto, final huhu.Bean2 entity) {
   ...
   * 
   */
  protected Date toDto_pdate(final huhu.Bean2 in) {
    return in.getPdate();
  }

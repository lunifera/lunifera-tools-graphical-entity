...
import org.lunifera.dsl.semantic.common.types.provider.LOperationItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.lunifera.dsl.semantic.dto.LDtoOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LDtoOperationItemProvider extends LOperationItemProvider {
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LDtoOperation.class)) {
			case LunDtoPackage.LDTO_OPERATION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case LunDtoPackage.LDTO_OPERATION__MULTIPLICITY:
			case LunDtoPackage.LDTO_OPERATION__ANNOTATION_INFO:
			case LunDtoPackage.LDTO_OPERATION__MAPPER:

...
/**
 * This is the item provider adapter for a {@link org.lunifera.dsl.semantic.entity.LOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LOperationItemProvider extends org.lunifera.dsl.semantic.common.types.provider.LOperationItemProvider {
	/**
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LOperation.class)) {
			case LunEntityPackage.LOPERATION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case LunEntityPackage.LOPERATION__MULTIPLICITY:
			case LunEntityPackage.LOPERATION__ANNOTATION_INFO:
			case LunEntityPackage.LOPERATION__PERSISTENCE_INFO:
